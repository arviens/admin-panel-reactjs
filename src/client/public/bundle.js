...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Layout = __webpack_require__(/*! ./components/Layout */ 168);
...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactRef.shouldUpdateRefs = function (prevElement, nextElement) {
	  ...
	  // of the compiled this.props because the post processing cannot determine
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactCompositeComponentMixin = {
	  ...
	  unmountComponent: function (safely) {
	    ...
	    // leaks a reference to the compiled instance.
	   ...
	   * @param {object} nextProps Next compiled object to set as properties.
	   * @param {?object} nextState Next object to set as state.
	   * @param {?object} nextContext Next compiled object to set as context.
	   * @param {ReactReconcileTransaction} transaction
	   ...
	   * components.
	   *
	   * @return {ReactComponent} the compiled component instance.
	   * @internal
	   */
	  getPublicInstance: function () {
	    var inst = this._instance;
...
/***/ function(module, exports) {
	...
	/**
	 * `ReactInstanceMap` maintains a mapping from a compiled facing stateful
	 * instance (key) and the internal representation (value). This allows compiled
